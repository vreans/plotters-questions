...
margin: 38%;
margin-bottom: 20px;">
<button style="background-color:#3f51b5;color:white;padding: 11px;font-size: 30px;margin-right: 10px;" mat-raised-button (click)="onButtonClick()">Save font size</button>
